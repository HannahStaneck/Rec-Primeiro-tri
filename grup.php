...
<label style='color: blue'>insira sua aposta</label>
<br>
...
if ($animal == $id) {
    ...
    echo "<h1 style='color: blue'>Parabéns, você ganhou o 1° prêmio o valor de R$ $premio";
    $x = '';
    $animal == $x;
    $f = $arrayBichos[$x];
    echo "$x";
...
if ($animal == $id1) {
    ...
    $premio = $aposta *5;
    echo "<h1 style='color: blue'>Parabéns, você ganhou o 2° prêmio o valor de R$ $premio";
    $x = '';
    $animal == $x;
    $f = $arrayBichos[$x];
    echo "$x";
...
if ($animal == $id2) {
    ...
    $premio = $aposta *4;
    echo "<h1 style='color: blue'>Parabéns, você ganhou o 3° prêmio o valor de R$ $premio";
    $x = '';
    $animal == $x;
    $f = $arrayBichos[$x];
    echo "$x";
...
if ($animal == $id3) {
    ...
    $premio = $aposta *3;
    echo "<h1 style='color: blue'>Parabéns, você ganhou o 4° prêmio o valor de R$ $premio";
    $x = '';
    $animal == $x;
    $f = $arrayBichos[$x];
    echo "$x";
...
if ($animal == $id4) {
    ...
    $premio = $aposta *2;
    echo "<h1 style='color: blue'>Parabéns, você ganhou o 5° prêmio o valor de R$ $premio";
    $x = '';
    $animal == $x;
    $f = $arrayBichos[$x];
    echo "$x";
...
if ($animal != $id || $animal != $id1 ||$animal != $id2 ||$animal != $id3 ||$animal!= $id4) {
    echo "<h1 style='color: red'>“Que pena, você não ganhou”";
}
